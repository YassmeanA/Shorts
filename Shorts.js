...
if (VideoWrapper.classList.contains("active") || Array.from(SubPages).some(SubPage => SubPage.classList.contains("active")) || UploadVideo.classList.contains("active") || UploadAudio.classList.contains("active") || UploadCover.classList.contains("active") || Pages[1].classList.contains("active") || Pages[2].classList.contains("active") || Pages[3].classList.contains("active")) return;
